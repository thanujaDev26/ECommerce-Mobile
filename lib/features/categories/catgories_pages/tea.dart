...
class Tea extends StatefulWidget {
  ...
  @override
  State<Tea> createState() => _HandcraftsState();
}

class _HandcraftsState extends State<Tea> {
  late Future<List<TeaModel>> _teaProducts;

  @override
  void initState() {
    super.initState();
    _teaProducts = TeaService.fetchProducts();
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Food and Beverages')),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: FutureBuilder<List<TeaModel>>(
          future: _teaProducts,
          builder: (context, snapshot) {
            ...
            return GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () {
                      final selectedProduct = TeaModel(
                        id: product.id,
                        title: product.title,
                      ...
                      final allProducts = products.map((p) => TeaModel(
                        id: p.id,
                        title: p.title,
