...
class HandcraftCommonUi extends StatelessWidget {
  ...
  const HandcraftCommonUi({super.key, required this.product, required this.allProducts});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SimilarHandcraftProductsSuggession(currentProduct: product, allProducts: allProducts,),
              ],
            ),
          ),
        ],
